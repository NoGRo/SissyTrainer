module.export = {
    prepare: {
        ...
        onFourDown: ["acostate boca abajo", "boca abajo, piernas estiradas, culo para afuera"],
        onFourSpread: ["en cuatro, abri las piernas lo mas que puedas", "en cuatro abri  bien las piernas y baja el culo"],
